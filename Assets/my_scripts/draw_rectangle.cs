...
public class draw_rectangle : MonoBehaviour {
	...
	void Start () {
        ...
        int cellResolution = (int)Mathf.Floor(resolution.x / cellSize);
        int cellCount = cellResolution * cellResolution;
    ...
    { 
        if(Input.GetMouseButtonDown(0))
        {
            ...
            int offsetY = (int)Mathf.Floor((targetPos.y - position.y) / cellSize);
